...
You have also among your weapons the Lipsum class, with which you can generate dummy text at the speed of light:
  ...
  Lipsum.paragraphs 4  # Generate four paragraphs of dummy text
  Lipsum.sentences 3   # Generate three sentences of dummy text
  Lipsum.words 10      # generate 10 words of dummy text
