...
Sitetree nodes and their variables lets you easily make use of page-specific or group-specific variables in your code.
...
You have also among your weapons the Lipsum class, with which you can generate dummy text at the speed of light:
